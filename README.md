...
> [!NOTE]
> Rather than using my JSON emoji dictionary, I recommend installing the [Plover Emoji](https://github.com/morinted/plover_emoji) plugin using the [Plover plugin manager](https://plover.wiki/index.php/Plugins) to write *any* emoji.
